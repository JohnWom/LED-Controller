...
ScreenManager* Op = new ScreenManager(Home);
...
Selectable* setR = new CustomRGBSelectable("Set R          ", 0, 255, CustomRGBSelectable::R);
Selectable* setG = new CustomRGBSelectable("Set G          ", 0, 255, CustomRGBSelectable::G);
Selectable* setB = new CustomRGBSelectable("Set B          ", 0, 255, CustomRGBSelectable::B);
